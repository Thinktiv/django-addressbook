...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.linkedin_handle'
        db.add_column('addressbook_contact', 'linkedin_handle',
                      self.gf('django.db.models.fields.CharField')(max_length='50', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.linkedin_handle'
        db.delete_column('addressbook_contact', 'linkedin_handle')
